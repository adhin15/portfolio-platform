  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap relative p-12">
        ...
        <div className="w-1/4 p-2 flex flex-wrap">
          <BlockColors colorTheme={colorTheme} />
        </div>
        <div className="w-1/4 p-2 flex flex-wrap">
          <img src="./assets/images/circuit-board.jpg" className="w-full h-full object-cover" />
        </div>
        <div className="w-1/4 p-2 flex flex-wrap">
          <img src="./assets/images/man-with-suit.jpg" className="w-full h-full object-cover" />
        </div>
        <div className="w-1/4 p-2 flex flex-wrap">
          <div
      ...
      <div className="p-12 flex">
        <div className="p-4 w-1/2 flex flex-col gap-4">
          ...
          <span>
            Our journey began cover a decade ago, driven by a passion for delivering cutting-edge solutions to business
            worldwide.
          </span>
        ...
        <div className="p-4 w-1/2 flex flex-wrap items-end">
          <div className="h-1/3 w-1/6" style={{ background: colorTheme?.accent }}></div>
          <img src="./assets/images/man-with-suit-2.jpg" className="w-5/6 h-full object-cover" />
          <div className="h-1/5 w-1/6" style={{ background: colorTheme?.secondaryAccent }}></div>
          <div className="h-1/5 w-1/4" style={{ background: colorTheme?.accent }}></div>
        </div>
      </div>
    </div>
  );
